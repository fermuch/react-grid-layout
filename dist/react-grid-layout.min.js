                ...
                if (p) {
                  ...
                  if (w.length > 0) {
                    var x = w.reduce(
                      function(t, e) {
                        return (
                          e.x > v && t.x.push(e.x), e.y > b && t.y.push(e.y), t
                        );
                      },
                      { x: [], y: [] }
                    );
                    x.x.sort(),
                      x.y.sort(),
                      x.x.length > 0 && (h = x.x[0] - d.x),
                      x.y.length > 0 && (y = x.y[0] - d.y);
                  }
                }
                (d.w = h), (d.h = y);
                var S = { w: h, h: y, x: d.x, y: d.y, static: !0, i: t };
                this.props.onResize(u, l, d, S, o, a),
                  this.setState({
              ...
              return function(n, r) {
                ...
                if (s) {
                  ...
                  var p = e.calcXY(u.top, u.left),
                    d = p.x,
                    h = p.y;
                  s.call(e, e.props.i, d, h, { e: n, node: o, newPosition: u });
                }
              };
            }),
            ...
            (n = e = (function(e) {
              function n() {
                ...
                for (var s = arguments.length, u = Array(s), l = 0; l < s; l++)
                  u[l] = arguments[l];
                return (
                  (t = r = a(this, e.call.apply(e, [this].concat(u)))),
                  (r.state = { width: 1280 }),
                  (r.mounted = !1),
                  (r.onWindowResize = function() {
                    if (r.mounted) {
                      var t = d.default.findDOMNode(r);
              ...
              return (
                ...
                (n.prototype.render = function() {
                  return this.props.measureBeforeMount && !this.mounted
                    ? l.default.createElement("div", {
                        className: this.props.className,
                        style: this.props.style
                      })
                    : l.default.createElement(t, s({}, this.props, this.state));
                }),
                n
              );
            })(l.default.Component)),
            (e.defaultProps = { measureBeforeMount: !1 }),
            (e.propTypes = { measureBeforeMount: f.default.bool }),
            n
          );
        };
      e.default = h;
